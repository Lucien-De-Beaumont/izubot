...
module.exports = {
    ...
    async runInteraction(client, interaction) {
        ...
        collector.on('collect', async collected => {
            ...
            const [results0] = await db.query(`SELECT * FROM HeroicAcademy WHERE discordid=${db.escape(interaction.guild.members.cache.find(member => member.displayAvatarURL() == message.embeds[0].thumbnail.url).id)} AND nom LIKE ${fieldOfSearch} ORDER BY nom ASC LIMIT 5`);
