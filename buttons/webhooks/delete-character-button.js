...
module.exports = {
    ...
    async runInteraction(client, interaction) {
        ...
        await db.query(`DELETE FROM HeroicAcademy WHERE discordid = ${db.escape(message.embeds[0].fields[2].value)} AND prefix=${db.escape(message.embeds[0].fields[1].value)}`);
